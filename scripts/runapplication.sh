...
echo "After=network.target[Service]ExecStart=/usr/bin/dotnet /home/ubuntu/webapp/csye6225/bin/Release/netcoreapp3.0/csye6225.dll" >> /etc/systemd/system/dotnetcore.service
